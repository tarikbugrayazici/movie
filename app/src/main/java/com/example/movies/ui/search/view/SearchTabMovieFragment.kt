...
import kotlinx.android.synthetic.main.fragment_search_tab_movie.*

class SearchTabMovieFragment : BaseFragment() {
    private var adapter: SearchTabMovieAdapter? = null
    var service = RetroFitService()
    private var text: String? = null
    override fun getFragmentLayoutId(): Int = R.layout.fragment_search_tab_movie

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        search_movie_recycler_view!!.layoutManager = (GridLayoutManager(context, 2))
        edit_movie.addTextChangedListener(object : TextWatcher {
    ...
    private fun fetchNamesMovie(text: String) {
